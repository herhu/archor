...
const create_patient_notification_dto_1 = require("../dtos/create-patient-notification.dto");
...
__decorate([
    (0, common_1.Post)(),
    (0, swagger_1.ApiOperation)({ summary: 'Create PatientNotification' }),
    (0, swagger_1.ApiOAuth2)(['patient:write']),
    ...
    __metadata("design:paramtypes", [create_patient_notification_dto_1.CreatePatientNotificationDto]),
    __metadata("design:returntype", Promise)
], PatientNotificationController.prototype, "create", null);
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'List PatientNotifications' }),
    (0, swagger_1.ApiOAuth2)(['patient:read']),
    (0, common_1.UseGuards)(jwt_guard_1.JwtAuthGuard, scopes_guard_1.ScopesGuard),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Get PatientNotification' }),
    (0, swagger_1.ApiOAuth2)(['patient:read']),
    (0, common_1.UseGuards)(jwt_guard_1.JwtAuthGuard, scopes_guard_1.ScopesGuard),
    (0, scopes_decorator_1.Scopes)('patient:read'),
...
__decorate([
    (0, common_1.Patch)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Update PatientNotification' }),
    (0, swagger_1.ApiOAuth2)(['patient:write']),
    (0, common_1.UseGuards)(jwt_guard_1.JwtAuthGuard, scopes_guard_1.ScopesGuard),
    (0, scopes_decorator_1.Scopes)('patient:write'),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Delete PatientNotification' }),
    (0, swagger_1.ApiOAuth2)(['patient:write']),
    (0, common_1.UseGuards)(jwt_guard_1.JwtAuthGuard, scopes_guard_1.ScopesGuard),
    (0, scopes_decorator_1.Scopes)('patient:write'),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Toggle' }),
    (0, swagger_1.ApiOAuth2)([]),
    (0, common_1.UseGuards)(jwt_guard_1.JwtAuthGuard, scopes_guard_1.ScopesGuard),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Status' }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
...
exports.PatientNotificationController = PatientNotificationController = __decorate([
    ...
    __metadata("design:paramtypes", [patient_notification_service_1.PatientNotificationService])
], PatientNotificationController);
//# sourceMappingURL=patient-notification.controller.js.map