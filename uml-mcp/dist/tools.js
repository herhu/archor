...
export function registerTools(server) {
    server.tool("uml_parse_ascii", "Parse ASCII DSL text into DiagramIR.", {
    ...
    server.tool("uml_validate_ir", "Validate a DiagramIR object.", {
    ...
    server.tool("uml_ir_to_designspec", "Transform DiagramIR into Archon DesignSpec v1.", {
        ir: z.any().describe("The DiagramIR JSON object.")
    }, async ({ ir }) => {
        // Validate first?
